...
# FIX 1: HARDCODED FALLBACKS + AUTO-PICK UP RENDER'S ACTUAL HOSTNAME
...
if RENDER_EXTERNAL_HOSTNAME:
    ...
    # fallback for local/manual runs where the env var isn't set
    ALLOWED_HOSTS += ['hello-fly-014e.onrender.com', 'hello-fly-o14e.onrender.com']

# FIX 2: CSRF TRUSTED ORIGINS DERIVED FROM ALLOWED_HOSTS SO THEY STAY IN SYNC
